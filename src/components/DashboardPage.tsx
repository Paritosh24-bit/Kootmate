...
`;
  ...
  const cbseSubjects = [
    ...
    },
    {
      ...
      name: 'Social Studies',
      board: 'cbse' as const,
      desc: 'Unified history, democratic politics, geography, and development economics.',
      lessons: [
        'The Rise of Nationalism in Europe',
        'Nationalism in India',
        'The Making of a Global World',
          ...
          <div className="space-y-6 text-left">
            ...
            {isSSTSubject && (
              <div className="p-6 rounded-3xl border border-indigo-100 bg-white shadow-sm space-y-4 text-left animate-fadeIn" id="sst-branch-selector-panel">
                ...
                <div className={`grid grid-cols-1 gap-3 ${selectedSubject!.board === 'cbse' ? 'sm:grid-cols-2 lg:grid-cols-4' : 'sm:grid-cols-2'}`}>
                  {(selectedSubject!.board === 'cbse'
                    ? [
                        ...
                        { key: 'economics', name: 'Economics 💰', desc: 'Development, financial sectors, credit & globalisation.' }
                      ]
                    : [
